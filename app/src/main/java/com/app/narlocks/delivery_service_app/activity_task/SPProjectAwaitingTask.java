...
public class SPProjectAwaitingTask  extends AsyncTask<Integer, Void, Boolean> {
    ...
    public SPProjectAwaitingTask(SPProjectAwaitingFragment fragment) {
    ...
    protected Boolean doInBackground(Integer... params) {
        ...
        try {
            ...
            if (project != null) {
                Call<List<Project>> projectEvaluationCall = projectService.clientEvaluations(project.getClient().getId());
