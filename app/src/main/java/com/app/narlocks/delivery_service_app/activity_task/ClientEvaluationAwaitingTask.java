...
import com.app.narlocks.delivery_service_app.activity.ClientProjectEvaluationFragment;
...
public class ClientEvaluationAwaitingTask extends AsyncTask<Void, Void, Boolean> {
    ...
    private ClientProjectEvaluationFragment fragment;
    private String errorMessage;

    public ClientEvaluationAwaitingTask(ClientProjectEvaluationFragment fragment, int projectId, int qualification, String description, int profileId, int status) {
    ...
    protected void onPostExecute(Boolean ok) {
        if (ok) {
            this.fragment.loadClientProjects();
        } else {
